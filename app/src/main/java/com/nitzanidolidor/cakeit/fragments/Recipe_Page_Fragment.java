    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(Recipe_Page_FragmentDirections.actionRecipePageFragmentToMapsFragment(recipe));
            }});
        ...
        if (recipe !=null){
            ...
            {
                Picasso.get().load(recipe.recipeImageUrl).placeholder(R.drawable.cakeitlogo).into(recipeImage);
            }else {
