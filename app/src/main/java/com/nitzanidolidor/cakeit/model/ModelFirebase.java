...
//                String userId = User.getInstance().getUserId();
    ...
    public static Map<String, Object> toMap(Recipe recipe){
        ...
        map.put("latitude", recipe.getLatitude());
        map.put("longitude", recipe.getLongitude());
        return map;
    }
    ...
    private static Recipe fromMap(Map<String, Object> json){
        ...
        newRecipe.latitude = (Double) json.get("latitude");
        newRecipe.longitude = (Double) json.get("longitude");
